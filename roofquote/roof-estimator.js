(function () {
  ...
  const WEB3FORMS_ACCESS_KEY = "ede89102-d913-4183-b426-03deb06c8f88";

  function submitQuoteLead(tierName, total, monthly, surfaceSqFt) {
    const payload = {
      access_key: WEB3FORMS_ACCESS_KEY,
      subject: "New Roof Quote Request - " + (state.address || "Unknown address"),
      from_name: "Prime State Roofing - Instant Quote Tool",
      ...
      message: "Roof quote request submitted via the instant roof quote tool."
    };
  ...
  const drawStyles = [
    {
      ...
      paint: { "fill-color": "#d4a943", "fill-opacity": 0.22 }
    },
    {
      id: "gl-draw-polygon-fill-static",
      type: "fill",
      filter: ["all", ["==", "$type", "Polygon"], ["==", "mode", "static"]],
      paint: { "fill-color": "#e6bc55", "fill-opacity": 0.15 }
    },
    {
      id: "gl-draw-polygon-stroke-active",
      type: "line",
      filter: ["all", ["==", "$type", "Polygon"], ["!=", "mode", "static"]],
      paint: { "line-color": "#e6bc55", "line-width": 2.5 }
    },
    {
      id: "gl-draw-polygon-stroke-inactive",
      type: "line",
      filter: ["all", ["==", "$type", "Polygon"], ["==", "mode", "static"]],
      paint: { "line-color": "#d4a943", "line-width": 2.5 }
    },
    {
      id: "gl-draw-polygon-and-line-vertex-active",
      type: "circle",
      filter: ["all", ["==", "meta", "vertex"], ["==", "$type", "Point"]],
      paint: { "circle-radius": 5, "circle-color": "#e6bc55" }
    },
    {
      id: "gl-draw-polygon-and-line-vertex-inactive",
      type: "circle",
      filter: ["all", ["==", "meta", "vertex"], ["==", "$type", "Point"], ["!=", "active", "true"]],
      paint: { "circle-radius": 4, "circle-color": "#d4a943" }
    }
  ];
